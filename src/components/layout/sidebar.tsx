...
const navItems = [
  ...
  { id: 'external-purchases', labelEn: 'External Purchases', labelAr: 'مشتريات خارجية', href: '/external-purchases', icon: 'ExternalLink' },
...
function NavIcon({ icon }: { icon: string }) {
  ...
  switch (icon) {
    ...
    case 'ExternalLink': return <svg {...svgProps}><path strokeLinecap="round" strokeLinejoin="round" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>;
