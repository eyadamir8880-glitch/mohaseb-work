...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b bg-white/80 px-4 backdrop-blur-sm dark:bg-slate-950/80 dark:border-slate-700 sm:px-6">
      <div className="flex items-center gap-3">
        <button onClick={() => setMobileSidebarOpen(!mobileSidebarOpen)} className="btn-ghost p-2 lg:hidden" title={t('app.toggleSidebar')}>
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M4 6h16M4 12h16M4 18h16" />
          </svg>
        </button>
        <h1 className="text-base font-semibold sm:text-lg">{t('app.name')}</h1>
      </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        ...
        {/* Save Session */}
        <button onClick={handleSaveSession} className="btn-ghost p-2 hidden sm:inline-flex" title={t('common.saveSession')}>
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        {/* Load Session */}
        <button onClick={handleLoadSession} className="btn-ghost p-2 hidden sm:inline-flex" title={t('common.loadSession')}>
          <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
