...
const SUPABASE_SQL_EDITOR = 'https://supabase.com/dashboard/project/kggmwviapfqtddxjmrwd/sql/new';
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="mx-auto max-w-4xl">
        ...
        <p className="mb-6 text-gray-600">
          The Supabase tables are missing required columns. Run this SQL in the Supabase SQL Editor to fix them.
        </p>

        <div className="mb-6 rounded-lg border bg-white p-4">
          <h2 className="mb-2 font-semibold">Step 1: Copy the SQL</h2>
          <p className="mb-3 text-sm text-gray-500">
            Click the copy button below, then click the link to open the Supabase SQL Editor.
          </p>
        ...
        <div className="mb-6 rounded-lg border bg-white p-4">
          <h2 className="mb-2 font-semibold">Step 2: Paste & Run</h2>
          <p className="text-sm text-gray-500">
            In the SQL Editor, paste the SQL and click <strong>Run</strong>. Wait for it to complete.
          </p>
        </div>

        <div className="rounded-lg border bg-white p-4">
          <h2 className="mb-2 font-semibold">Migration SQL</h2>
          <pre className="overflow-auto rounded bg-gray-900 p-4 text-xs text-green-400 max-h-[60vh]">
